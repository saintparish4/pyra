...
const TRUST_STATS = [
  { value: "30,000", label: "US fire departments locked into 3 PE-backed vendors" },
  { value: "2 / 3", label: "of departments are volunteer — and hit hardest by price hikes" },
  { value: "AGPL-3.0", label: "licensed from the first commit; the code is forkable forever" },
  { value: "Co-op", label: "governed by a nonprofit/cooperative that cannot be acquired" },
];
    ...
    <section className="lp-section lp-split" id="mobile">
      ...
      <div className="phone" aria-hidden="true">
        <div className="phone-screen">
          ...
          <div className="phone-sync">Will sync &amp; validate on reconnect</div>
        </div>
      </div>
    </section>
  );
...
const ROADMAP = [
  ...
  { name: "Historical data import", phase: "MVP", note: "NFIRS 5.0 / eNFIRS, Emergency Reporting CSV" },
  { name: "Training & certifications", phase: "Fast-follow", note: "Drills, hours, expirations" },
  { name: "Apparatus & SCBA checks", phase: "Fast-follow", note: "Daily and weekly checklists" },
  { name: "Pre-plans & occupancy intel", phase: "Roadmap", note: "Hydrants, access, hazards at dispatch" },
  { name: "Inspections", phase: "Roadmap", note: "Scheduling, findings, follow-ups" },
];
  ...
  return (
    <section className="lp-section" id="pre-incident">
      ...
      <ul className="roadmap">
        {ROADMAP.map((r) => (
          <li key={r.name}>
            <span className={`chip chip-phase-${r.phase.toLowerCase().replace("-", "")}`}>
              {r.phase}
            </span>
      ...
      <div className="card-grid cols-2">
        <article className="card">
          ...
          <ul className="plain-list">
            <li>NERIS submission adapter — retry queue, status polling, rejection reasons surfaced</li>
            <li>NFIRS 5.0 flat-file and eNFIRS bulk import</li>
            <li>Emergency Reporting CSV import for displaced departments</li>
            <li>Documented, versioned schema — the export format is a public spec</li>
          </ul>
        </article>
        <article className="card">
          <h3>Reliability & security</h3>
          <ul className="plain-list">
            <li>Scheduled automated backups with a documented, drilled restore procedure</li>
            <li>Encrypted in transit and at rest; OWASP ASVS Level 2 target</li>
            <li>Row-level security enforces department isolation on shared instances</li>
            <li>Email + password with TOTP 2FA, magic links for low-tech members</li>
            <li>No PHI in scope — ePCR is deliberately excluded from the MVP</li>
          </ul>
        </article>
      </div>
    </section>
      ...
      <div className="lp-split-copy">
        ...
        <ul className="checklist">
          <li>
            ...
            — the charts an ISO review or AFG grant narrative actually asks
            for.
          </li>
          <li>
    ...
    <section className="lp-section" id="case-study">
      ...
      <div className="case">
        ...
        <ol className="case-timeline">
          ...
          <li>
            <strong>Week 2 — Import.</strong> Four decades of NFIRS history
            come in through the importer: dry run, fix eleven flagged records,
  ...
  return (
    <section className="lp-section" id="demo">
      <div className="cta-panel">
        ...
        <p>
          We're onboarding pilot departments now — full historical import,
